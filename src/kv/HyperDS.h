...
#ifndef CEPH_OS_BLUESTORE_HYPERDS_H
#define CEPH_OS_BLUESTORE_HYPERDS_H
...
class HyperDS : public KeyValueDB
{
  ...
  typedef hdb_set_t::iterator hdb_iter_t;
  hdb_set_t h_set;
  //#### HYPERDS #####

public:
  HyperDS(CephContext *c, const string &path, void *p) :
  ...
  class MDBTransactionImpl : public KeyValueDB::TransactionImpl {
    ...
    MDBTransactionImpl(HyperDS* _db) :m_db(_db)
    {
      ops.clear();
    }
